<div class="row">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
        <div class="dashboard_stats_wrap">
            ...
            <div class="dashboard_stats_wrap_content"><h4>8</h4> <span>Artikel Tersedia</span></div>
        </div>	
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
        <div class="dashboard_stats_wrap">
            ...
            <div class="dashboard_stats_wrap_content"><h4>8</h4> <span>Check Pembayaran</span></div>
        </div>	
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
        <div class="dashboard_stats_wrap">
            ...
            <div class="dashboard_stats_wrap_content"><h4>8</h4> <span>Pengguna Baru</span></div>
        </div>	
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
        <div class="dashboard_stats_wrap">
            ...
            <div class="dashboard_stats_wrap_content"><h4>8</h4> <span>Webinar Tersedia</span></div>
        </div>	
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="grousp_crs">
                    <a href="<?= base_url('assets/img/webinar/webinar_1.png'); ?>" data-fancybox>
                        <img src="<?= base_url('assets/img/webinar/webinar_1.png'); ?>" class="img-fluid mr-3" width="125" />
                    </a>
                    <div class="grousp_crs_left">
                        <div class="grousp_crs_caption"><h4>Mengatasi Stress Akibat Tekanan Kerja</h4><br>Unknown</div>
                    </div>
            ...
            <div class="ground-list ground-hover-list">
                <div class="ground ground-list-single">
                    <div class="rounded-circle p-3 p-sm-4 d-flex align-items-center justify-content-center bg-light-success">
                        <div class="position-absolute text-success h5 mb-0"><img src="<?= base_url('assets/img/account/00870045.jpg'); ?>" class="img-fluid circle" width="60"></div>
                    </div>

                    <div class="ground-content">
                        <h6><a href="#">John Doe</a></h6>
                        <small class="text-fade">Pengguna Baru</small>
                        <span class="small">Bergabung pada 22 Januari 2021</span>
                    </div>
                </div>
            </div>
        </div>		
